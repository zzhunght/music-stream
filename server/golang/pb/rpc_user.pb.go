...
func (x *AuthenticationResponse) GetIssuedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.IssuedAt
	}
	return nil
...
var file_rpc_user_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xa0, 0x01, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72,
	...
	0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x62, 0x2e,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xdf, 0x01, 0x0a, 0x16, 0x41,
	...
	0x70, 0x52, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x41, 0x74, 0x42, 0x16, 0x5a, 0x14,
	0x6d, 0x75, 0x73, 0x69, 0x63, 0x2d, 0x61, 0x70, 0x70, 0x2d, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e,
...
var file_rpc_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_rpc_user_proto_goTypes = []interface{}{
	...
	(*AuthenticationResponse)(nil), // 2: pb.AuthenticationResponse
	(*UserResponse)(nil),           // 3: pb.UserResponse
	(*timestamppb.Timestamp)(nil),  // 4: google.protobuf.Timestamp
}
var file_rpc_user_proto_depIdxs = []int32{
	3, // 0: pb.UserLoginResponse.user:type_name -> pb.UserResponse
	4, // 1: pb.AuthenticationResponse.issued_at:type_name -> google.protobuf.Timestamp
	4, // 2: pb.AuthenticationResponse.expired_at:type_name -> google.protobuf.Timestamp
